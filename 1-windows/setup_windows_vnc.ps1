...
Write-Host "    VNC Port: $ReversePort" -ForegroundColor Gray
...
Write-Host "  VNC Port local: 5900" -ForegroundColor White
Write-Host "  VNC Port relay: $ReversePort" -ForegroundColor White
...
$timestamp = Get-Date -Format "yyyy-MM-dd HH:mm:ss"
"[$timestamp] VNC setup completed successfully (Config: $RelayServer:$ReversePort)" | Out-File -FilePath $setupLog -Append
