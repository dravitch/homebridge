...
# ====================================================================
#
# Ce script remplace les deux anciennes variantes fille-rdp.sh et
# rdp-fille.sh (ports différents, l'une contenant un mot de passe en
# clair). Il n'y a plus qu'un seul script, sans secret versionné :
# le mot de passe Windows est demandé de façon interactive (comme le
# fait déjà rdp.sh pour papa-windows), jamais stocké dans ce fichier.
...
LOCAL_RDP_PORT=13390  # Port différent de papa-windows (13389)
...
# Mot de passe demandé de façon interactive - jamais stocké en clair
# dans ce fichier versionné (cf. WINDOWS_PASSWORD dans l'ancien
# fille-rdp.sh, supprimé).
